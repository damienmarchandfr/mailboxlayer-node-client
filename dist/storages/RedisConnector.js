...
var RedisConnector = /** @class */ (function (_super) {
    __extends(RedisConnector, _super);
    function RedisConnector(redisClient) {
        var _this = _super.call(this) || this;
        _this.redisClient = redisClient;
        return _this;
    }
    RedisConnector.prototype.addEmailInfo = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var num;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.redisClient.existsAsync(email.email)];
                    case 1:
                        num = _a.sent();
                        if (!(num === 0)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.redisClient.setAsync(email.email, JSON.stringify(email))];
                    case 2:
                        _a.sent();
                        _a.label = 3;
