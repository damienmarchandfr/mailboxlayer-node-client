...
var FileConnector = /** @class */ (function (_super) {
    ...
    FileConnector.prototype.addEmailInfo = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.creaeFolder()
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 6]);
                        return [4 /*yield*/, fs.access(this.path + '/' + email.email)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 4:
                        error_1 = _a.sent();
                        // create file
                        return [4 /*yield*/, fs.writeFile(this.path + '/' + email.email, JSON.stringify(email))];
                    case 5:
                        // create file
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 6: return [2 /*return*/, email];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, fs.access(this.path + '/' + email)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    FileConnector.prototype.creaeFolder = function () {
        return __awaiter(this, void 0, void 0, function () {
            var error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 4]);
                        return [4 /*yield*/, fs.access(this.path)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2:
                        error_3 = _a.sent();
                        return [4 /*yield*/, fs.mkdir(this.path)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 4];
