...
var MongoConnector = /** @class */ (function (_super) {
    ...
    function MongoConnector(collection) {
        var _this = _super.call(this) || this;
        _this.collection = collection;
        return _this;
    }
    MongoConnector.prototype.getEmailInfo = function (email) {
    ...
    MongoConnector.prototype.addEmailInfo = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.collection.updateOne({ email: email.email }, { $set: email }, { upsert: true })];
                    case 1:
                        _a.sent();
